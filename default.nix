...
, conduit, conduit-extra, containers, crypton, crypton-connection
, data-default, data-endian, deepseq, directory, entropy
, exceptions, extra, feed, file-embed, filepath, hmatrix-glpk
, http-client, http-client-tls, http-conduit, http-types, HUnit
, iconv, isbn, lens, lens-aeson, lib, linear, memory, mime-types
...
, random, shakespeare, split, stm, tagsoup, template-haskell
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    entropy exceptions extra feed file-embed filepath hmatrix-glpk
    http-client http-client-tls http-conduit http-types HUnit iconv
    isbn lens lens-aeson linear memory mime-types monad-loops mtl
