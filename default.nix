...
, containers, crypton, data-default, data-endian, deepseq
, directory, entropy, extra, file-embed, filepath, hmatrix-glpk
, http-client, http-client-tls, http-conduit, http-types, HUnit
, iconv, lens, lens-aeson, lib, linear, memory, mime-types
...
, text-builder, text-manipulate, time, transformers, unix
, utf8-string, vector, xdg-basedir, xml-conduit, yaml, yesod
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    conduit conduit-extra containers crypton data-default data-endian
    deepseq directory entropy extra file-embed filepath hmatrix-glpk
    http-client http-client-tls http-conduit http-types HUnit iconv
    lens lens-aeson linear memory mime-types monad-loops mtl
    ...
    template-haskell temporary text text-builder text-manipulate time
