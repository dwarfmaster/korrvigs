...
, file-embed, filepath, hashable, hmatrix-glpk, http-client
, http-client-tls, http-conduit, http-types, HUnit, iconv, isbn
, lens, lens-aeson, lib, linear, memory, mime-types, monad-loops
, mtl, neat-interpolation, network-uri, opaleye
, optparse-applicative, pandoc, pandoc-types, parsec
, parsec3-numbers, password, postgresql-simple, process
, product-profunctors, profunctors, random, resourcet, shakespeare
, skylighting, split, sqlite-simple, stm, tagsoup, template-haskell
, temporary, text, text-builder, text-manipulate, time, tls
, transformers, unix, utf8-string, vector, xdg-basedir, xml-conduit
, xml-types, yaml, yesod, yesod-core, yesod-static
}:
mkDerivation {
  pname = "korrvigs";
  version = "0.1.0.0";
  ...
  libraryHaskellDepends = [
    ...
    hashable hmatrix-glpk http-client http-client-tls http-conduit
    http-types HUnit iconv isbn lens lens-aeson linear memory
    mime-types monad-loops mtl neat-interpolation network-uri opaleye
    ...
    random resourcet shakespeare skylighting split sqlite-simple stm
