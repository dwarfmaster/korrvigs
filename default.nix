...
, containers, data-default, data-endian, deepseq, directory, extra
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    conduit conduit-extra containers data-default data-endian deepseq
    directory extra file-embed filepath hmatrix-glpk http-client
    http-client-tls http-conduit http-types HUnit iconv lens lens-aeson
    linear mime-types monad-loops mtl network-uri opaleye
