...
cssName CssContact = "contact.css"
...
resolveCSS _ _ CssContact = $(cassiusFile $ css "contact.cassius")
...
contactStyle :: (CssFile -> Route site) -> WidgetFor site ()
contactStyle mkCss = addStylesheet $ mkCss CssContact
