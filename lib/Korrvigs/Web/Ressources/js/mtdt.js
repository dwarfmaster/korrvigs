...
function mtdtSetupEditButton(button) {
  ...
  button.addEventListener("click", function() {
    ...
    fetch(mtdtUrl).then((response) => response.json()).then((val) => {
      ...
      valInput.setAttribute("value", JSON.stringify(val))
      removeAllChilds(valTD)
...
Array.from(document.querySelectorAll(".metadata-table .mtdt-edit-button")).forEach(mtdtSetupEditButton)
...
Array.from(document.querySelectorAll(".metadata-table .mtdt-rm-button")).forEach(mtdtSetupRmButton)
